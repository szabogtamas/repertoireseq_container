...
params:
  ...
  tagged_repertoire: "/home/rstudio/local_files/report/reconstruction_logs"
...
ggsave(file.path(params$figure_path, "fig1.pdf"), plot=p, width=6.4, height=3.2, units="in")
show_fig(p)
```
...
ggsave(file.path(params$figure_path, "fig2.pdf"), plot=p, width=6.4, height=3.2, units="in")
show_fig(p)
```
...
ggsave(file.path(params$figure_path, "fig3.pdf"), plot=p, width=6.4, height=3.2, units="in")
show_fig(p)
```
...
ggsave(file.path(params$figure_path, "fig4.pdf"), plot=p, width=6.4, height=3.2, units="in")
show_fig(p)
```
...
ggsave(file.path(params$figure_path, "fig5.pdf"), plot=p, width=6.4, height=3.2, units="in")
show_fig(p)
```
...
ggsave(file.path(params$figure_path, "fig6.pdf"), plot=p, width=6.4, height=3.2, units="in")
p
```
...
ggsave(file.path(params$figure_path, "fig7.pdf"), plot=p, width=6.4, height=3.2, units="in")
p
```
...
ggsave(file.path(params$figure_path, "fig8.pdf"), plot=p, width=6.4, height=3.2, units="in")
show_fig(p)
```
